      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h1 class="animated fadeIn"><i class="fa fa-car car-yello-icon" aria-hidden="true"></i>  BOOKING STATUS </h1>
          </div>
        </div>
      </div>
    </div>
...
<?php 
	...
	$ConsumerReference = '121334';
	$PaymentReference = '45455';
	$amount = 50;
	$currency='GBP';
	include "judopay/judopay.php";
?>
<form action="<?php echo $formPostUrl;?>" method="post">
   ...
   <input type="submit" class="book-now-btn" value="Pay now">
</form>
